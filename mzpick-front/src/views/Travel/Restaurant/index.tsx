...
import { TRAVEL_PATH, TRAVEL_RESTAURANT_DETAIL_PATH, TRAVEL_STAY_PATH, WRITE_PATH } from 'src/constants';
...
export default function RestaurantMain() {
    ...
    const getRestaurantResponseDto = (resposenBody: GetRestaurantListResponseDto | ResponseDto | null) => {
      ...
      setOriginalList(travelFoodList);
      ...
      if (query) {
        ...
        const filteredList = travelFoodList.filter(item => item.travelLocathion.includes(query));
        ...
        <div className='board-top'>
          <div className='drop-down-box'>
            ...
            <div className={`drop-down-sub ${dropDownOpen ? 'active' : ''}`}>
              ...
              <div className='drop-down-sub-text' onClick={() => onDropDownSelect(TRAVEL_RESTAURANT_DETAIL_PATH)}>카페</div>
